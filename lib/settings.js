...
const Checkbox = ({ value, label, onChange }) => {
    ...
    return (react.createElement(CheckBox_Container, null,
        react.createElement("div", { className: 'iconContainer' },
            react.createElement(Icon, { src: src }),
            react.createElement(CheckboxSquare, { type: "checkbox", name: label, checked: value, onClick: () => onChange(!value) })),
    ...
    return (react.createElement(Body, null,
        ...
        react.createElement(Container, null,
            ...
            react.createElement(SettingsBlock, null,
                react.createElement(H2, null, "OpenAI API Token \u26A0\uFE0F"),
                react.createElement(Space, { height: 3 }),
                react.createElement(Subtitle, null,
                    "Required. You can find your Secret API key in your ",
                    react.createElement("a", { href: "https://platform.openai.com/account/api-keys" }, "OpenAI User settings"),
                    "."),
                react.createElement(Space, { height: 10 }),
                react.createElement(TextInput, { type: "text", placeholder: 'Put your secret API token here' })),
            react.createElement(SettingsBlock, null,
                react.createElement(H2, null, "Text Generation"),
                react.createElement(Space, { height: 10 }),
                react.createElement(Checkbox, { value: true, onChange: () => { }, label: 'Add TweetGPT Signature' }),
                react.createElement(Space, { height: 10 }),
                react.createElement(Checkbox, { value: false, onChange: () => { }, label: 'Ask for tweet topic in replies' })),
            react.createElement(SettingsBlock, null,
                react.createElement(H2, null, "Language"),
                react.createElement(Space, { height: 10 }),
                react.createElement(Selector, { value: 'en', onChange: () => { }, options: [{ value: 'en', label: 'English' }, { value: 'es', label: 'Spanish' }] })))));
};
