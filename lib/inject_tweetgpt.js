...
;// CONCATENATED MODULE: ./node_modules/@firebase/auth/dist/esm2017/index-e3f1fbba.js
 ...
 * limitations under the License.
 */
const index_e3f1fbba_DB_NAME = 'firebaseLocalStorageDb';
const index_e3f1fbba_DB_VERSION = 1;
...
function _deleteDatabase() {
    const request = indexedDB.deleteDatabase(index_e3f1fbba_DB_NAME);
    return new DBPromise(request).toPromise();
}
function _openDatabase() {
    const request = indexedDB.open(index_e3f1fbba_DB_NAME, index_e3f1fbba_DB_VERSION);
    return new Promise((resolve, reject) => {
...
var index_e3f1fbba_name = "@firebase/auth";
var index_e3f1fbba_version = "0.21.4";
...
function registerAuth(clientPlatform) {
    ...
    registerVersion(index_e3f1fbba_name, index_e3f1fbba_version, getVersionForPlatform(clientPlatform));
    // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
    registerVersion(index_e3f1fbba_name, index_e3f1fbba_version, 'esm2017');
}
...
;// CONCATENATED MODULE: ./src/inject/inject_tweetgpt.ts
...
window.addEventListener("load", () => {
    ...
    onAuthStateChanged(auth, async (user) => {
        if (user) {
            const token = user.accessToken; // incorrect typings
